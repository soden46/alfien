    ...
    <div class="card">
        <div class="card-body">
            <div class="header mb-3">
                <img src="{{ public_path('storage/bloomery.png') }}" alt="" width="42px" height="42px" />
                <h1 class="text-center">Bloomery Patisserie<br>
                    <P class="text-center">Jl Kaliurang Caturtunggal Sleman</P>
            ...
            <div class=" tandatangan">
                <br>
                <p style="padding-bottom:25px">Sleman, {!!$tgl!!}</p>
                <p>{{Auth::user()->nama}}</p>
            </div>
        </div>
    </div>
