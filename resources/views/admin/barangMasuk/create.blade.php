@extends('layouts.app', [
'title' => 'Form Data Barang Masuk',
'pageTitle' => 'Form Data Barang Masuk',
])
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <form id="quickForm" action="{{ route('barang-masuk/create/post') }}" method="POST">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-floating mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="supplier" class="form-control @error('supplier')is-invalid @enderror" id="supplier" placeholder="Masukan Supplier" required value="{{old('supplier')}}">
                                        @error('supplier')
                                ...
                                <table class="table table-bordered" id="myTable1">
                                    ...
                                    <tbody id="tbody1">
                                        <tr id="R1">
                                            ...
                                            <td>
                                                <button class="btn btn-primary btn-sm mb-3" id="addBtn1" type="button"><i class="fas fa-plus"></i></button>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
